...
class FlexTableChangeNotifier<T> {
  int _count = 0;
  ...
  static bool debugAssertNotDisposed(FlexTableChangeNotifier notifier) {
    assert(() {
  ...
  void addListener(T listener) {
    assert(FlexTableChangeNotifier.debugAssertNotDisposed(this));
    if (kFlutterMemoryAllocationsEnabled && !_creationDispatched) {
      MemoryAllocations.instance.dispatchObjectCreated(
        library: _flutterFoundationLibrary,
        className: '$FlexTableChangeNotifier',
        object: this,
      );
      ...
      try {
        ...
        FlutterError.reportError(FlutterErrorDetails(
          ...
          informationCollector: () => <DiagnosticsNode>[
            DiagnosticsProperty<FlexTableChangeNotifier>(
