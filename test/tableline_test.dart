...
import 'package:flextable/src/model/mergable_lines.dart';
...
void main() {
  test('line', () async {
    ...
    horizontalLines.addLineRanges((create) {
      create(LineRange(
          startIndex: 1,
      ...
      create(LineRange(
          ...
          lineNodeRange: LineNodeRange(list: [
            ...
            LineNode(startIndex: 3, before: blueLine)
          ])));
    });
    ...
    //     endIndex: 2,
    //     lineNodeRange: LineNodeRange(list: [
    //       LineNode(startIndex: 0, before: blueLine),
    //       LineNode(startIndex: 1, after: blueLine),
    //       LineNode(startIndex: 1, before: blueLine),
