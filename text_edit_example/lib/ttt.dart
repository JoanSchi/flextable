...
class TextTableBuilder extends AbstractTableBuilder<FtModel<Cell>, Cell> {
  TextTableBuilder(
...
class TableEditText extends StatefulWidget {
  const TableEditText({
    super.key,
    required this.edit,
    required this.askNextFocus,
  });
  final bool edit;
  final AskForNextFocus askNextFocus;

  @override
  State<TableEditText> createState() => _TableEditTextState();
}

typedef AskForNextFocus = bool Function();

class _TableEditTextState extends State<TableEditText> {
  final TextEditingController tec = TextEditingController();
  late final FocusNode focusNode = MyFocusNode(ask: () {
    return widget.askNextFocus();
  });
  ...
  @override
  void didUpdateWidget(covariant TableEditText oldWidget) {
    focusNode.requestFocus();
