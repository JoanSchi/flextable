...
class RowChangeTableBuilder
    extends AbstractTableBuilder<ChangeRowModel<Cell>, Cell> {
  RowChangeTableBuilder(
  ...
  @override
  Widget buildHeaderIndex(BuildContext context, ChangeRowModel model,
  ...
  @override
  void finalPaintMainPanel(FtViewModel<ChangeRowModel<Cell>, Cell> viewModel,
