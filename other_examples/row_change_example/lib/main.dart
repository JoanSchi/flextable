...
import 'package:text_edit_example/table_builder.dart';
...
class _RowChangeExampleState extends State<TextEditExample>
  ...
  final FtController<ChangeRowModel<Cell>, Cell> _ftController =
      FtController<ChangeRowModel<Cell>, Cell>();
  ...
  Widget build(BuildContext context) {
    ...
    final model = ChangeRowModel<Cell>(
      columnHeader: true,
      rowHeader: true,
    ...
    return Scaffold(
      ...
      body: FlexTable<ChangeRowModel<Cell>, Cell>(
        rebuildNotifier: rebuildNotifier,
        backgroundColor: Colors.white,
        controller: _ftController,
        model: model,
        tableBuilder: RowChangeTableBuilder(),
      ),
